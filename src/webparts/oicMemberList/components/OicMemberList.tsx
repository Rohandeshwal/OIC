...
import styles from "./OicMemberList.module.scss";
import { IOicMemberListProps } from "./IOicMemberListProps";
import { escape } from "@microsoft/sp-lodash-subset";
require("./OicMemberList.css");
...
export default class OicMemberList extends React.Component<
  IOicMemberListProps,
  {}
> {
  ...
  public render(): React.ReactElement<IOicMemberListProps> {
    return (
      <div className={styles.oicMemberList}>
          ...
          >
            <div className={["modal-content", styles.modalContent].join(" ")}>
              <div className={["modal-header", styles.modalHeader].join(" ")}>
                ...
                />{" "}
                &nbsp;
                <h5 className={styles.heading}>OIC Member Details</h5>
                <button
                  type="button"
                  className="close"
                  data-dismiss="modal"
