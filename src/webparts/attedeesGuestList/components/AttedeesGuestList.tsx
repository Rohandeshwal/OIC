...
import styles from "./AttedeesGuestList.module.scss";
import { IAttedeesGuestListProps } from "./IAttedeesGuestListProps";
...
require("./AttedeesGuestList.css");

import { faArrowLeft } from "@fortawesome/free-solid-svg-icons";

export default class AttedeesGuestList extends React.Component<
  IAttedeesGuestListProps,
  {}
> {
  public render(): React.ReactElement<IAttedeesGuestListProps> {
    return (
      <div className={styles.attedeesGuestList}>
                ...
                <form>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-4 d-flex align-items-center">
                      <span>
                        This will come from the master Data +we will have
                        "Others".
                      </span>
                    </div>
                  </div>
