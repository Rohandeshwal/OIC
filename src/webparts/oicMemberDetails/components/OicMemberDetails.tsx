...
import styles from "./OicMemberDetails.module.scss";
import { IOicMemberDetailsProps } from "./IOicMemberDetailsProps";
import { escape } from "@microsoft/sp-lodash-subset";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faEllipsisV } from "@fortawesome/free-solid-svg-icons";
require("./OICMemberDetails.css");

export default class OicMemberDetails extends React.Component<
  IOicMemberDetailsProps,
  {}
> {
  public render(): React.ReactElement<IOicMemberDetailsProps> {
    return (
      <div className={styles.oicMemberDetails}>
        ...
        >
          <div className="row">
            <div className="col-lg-6 col-md-6">
              <h5 className={styles.heading}>List of OIC Member</h5>
            </div>
            <div className="col-lg-6 col-md-6">
