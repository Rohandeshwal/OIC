...
import styles from "./EventViewGuest.module.scss";
import { IEventViewGuestProps } from "./IEventViewGuestProps";
...
export default class EventViewGuest extends React.Component<
  IEventViewGuestProps,
  {}
> {
  public render(): React.ReactElement<IEventViewGuestProps> {
    return (
      <div className={styles.eventViewGuest}>
        <button
          type="button "
          data-toggle="modal"
          ...
          >
            <div className={["modal-content", styles.modalContent].join(" ")}>
              <div className={["modal-header", styles.modalHeader].join(" ")}>
                ...
                />
                <h5 className={styles.heading}>View Add Guest</h5>
                <button
                  type="button"
                  ...
                  <div className="col-md-9">
                    ...
                    <div className="row mt-2">
                      <div className="col-md-4">
                        <p className={styles.modealLabelText}>Organisation</p>
                        <p className={styles.modalNameText}>Organisation1</p>
                      </div>
                      <div className="col-md-4">
                        <p className={styles.modealLabelText}> Email ID</p>
