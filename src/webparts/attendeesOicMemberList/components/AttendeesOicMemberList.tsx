...
import styles from "./AttendeesOicMemberList.module.scss";
import { IAttendeesOicMemberListProps } from "./IAttendeesOicMemberListProps";
...
require("./AttendeesOICMemberList.css");

export default class AttendeesOicMemberList extends React.Component<
  IAttendeesOicMemberListProps,
  {}
> {
  public render(): React.ReactElement<IAttendeesOicMemberListProps> {
    return (
      <div className={styles.attendeesOicMemberList}>
        <div className=" d-flex justify-content-between mt-3 mr-4 mb-2">
          <div>EVENT_TITLE</div>
        ...
        <div className={styles.actionContainer}>
          <div className=" d-flex justify-content-between mb-2">
            <div className=" mr-auto">
              <h5 className={styles.heading}>Attendees-OIC Members</h5>
            </div>
