...
import styles from "./MemberStateDetails.module.scss";
import { IMemberStateDetailsProps } from "./IMemberStateDetailsProps";
import { escape } from "@microsoft/sp-lodash-subset";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faEllipsisV } from "@fortawesome/free-solid-svg-icons";
require("./MemberStateDetails.css");

export default class MemberStateDetails extends React.Component<
  IMemberStateDetailsProps,
  {}
> {
  public render(): React.ReactElement<IMemberStateDetailsProps> {
    return (
      <div className={styles.memberStateDetails}>
        ...
        >
          <div className="row">
            <div className="col-lg-6 col-md-6">
              <h5 className={styles.heading}> Member State</h5>
            </div>
            <div className="col-lg-6 col-md-6">
