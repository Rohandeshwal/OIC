...
import { IAddOrganizationProps } from "./IAddOrganizationProps";
import { escape } from "@microsoft/sp-lodash-subset";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faEllipsisV } from "@fortawesome/free-solid-svg-icons";
require("./AddOrganization.css");

export default class AddOrganization extends React.Component<
  IAddOrganizationProps,
  {}
> {
  public render(): React.ReactElement<IAddOrganizationProps> {
    return (
        ...
        >
          <div className="row">
            <div className="col-lg-6 col-md-6">
              <h5 className={styles.heading}>Organizations</h5>
            </div>
            <div className="col-lg-6 col-md-6">
