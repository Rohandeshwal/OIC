...
import styles from "./ManageGuestDetails.module.scss";
import { IManageGuestDetailsProps } from "./IManageGuestDetailsProps";
import { escape } from "@microsoft/sp-lodash-subset";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faEllipsisV } from "@fortawesome/free-solid-svg-icons";
require("./ManageGuestDetails.css");

export default class ManageGuestDetails extends React.Component<
  IManageGuestDetailsProps,
  {}
> {
  public render(): React.ReactElement<IManageGuestDetailsProps> {
    return (
      <div className={styles.manageGuestDetails}>
        ...
        <div
          className={["py-3", styles.actionContainer, styles.borderBottom].join(
            " "
          )}
        >
          <div className="row">
            <div className="col-lg-6 col-md-6">
              <h5 className={styles.heading}>Manage Guest</h5>
            </div>
            <div className="col-lg-6 col-md-6">
