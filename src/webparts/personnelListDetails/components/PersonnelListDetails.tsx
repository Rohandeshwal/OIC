...
import styles from "./PersonnelListDetails.module.scss";
import { IPersonnelListDetailsProps } from "./IPersonnelListDetailsProps";
import { escape } from "@microsoft/sp-lodash-subset";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faEllipsisV } from "@fortawesome/free-solid-svg-icons";

export default class PersonnelListDetails extends React.Component<
  IPersonnelListDetailsProps,
  {}
> {
  public render(): React.ReactElement<IPersonnelListDetailsProps> {
    return (
      <div className={styles.personnelListDetails}>
        <div className=" d-flex justify-content-end mt-3 mr-4">
          <button type="button" className={styles.saveButton}>
            + ADD PERSONNEL
          </button>
        </div>
        <div className={["py-3" , styles.actionContainer, styles.borderBottom].join(' ')}>
          <div className="row">
            <div className="col-md-4 mr-auto">
            <h5 className={styles.heading}>List of Personnels</h5>
            </div>
